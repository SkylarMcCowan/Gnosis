...
well. Ability drain, however, is permanent, though *restoration* can restore even
those lost ability score points.
...
1 Each time the victim takes 2 or more damage from the disease, he must make
another Fortitude save or be permanently blinded.

2 When damaged, character must succeed on another saving throw or 1 point of
damage is permanent drain instead.

3 The victim must make three successful Fortitude saving throws in a row to
recover from devil chills.

4 Successful saves do not allow the character to recover. Only magical healing
...
chance to ignore any damage from a corporeal source-except for a force effect or
...
(or close with caster if attacking is not possible); 11-20, act normally; 21-50,
do nothing but babble incoherently; 51-70, flee away from caster at top possible
...
special advantage when attacking a *confused* character. Any *confused*
...
cowering character takes a -2 penalty to Armor Class and loses her Dexterity
bonus (if any).
